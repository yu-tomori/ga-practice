# function name like '_~~~' is protected function in python. 
# protected functions are only accessible to other functions in the same module.
 ...
 while True:
  ...
  if parent.Fitness > child.Fitness:
   ...
   if maxAge > parent.Age:
    continue
   # fitnessの向上につながらなかった世代数が閾値を超えたら以下の処理をする.
...
def get_best(get_fitness, targetLen, optimalFitness, geneSet, display, custom_mutate=None, custom_create=None, maxAge=None, poolSize=1, crossover=None, maxSeconds=None):
 ...
 strategyLookup = {
   ...
   Strategies.Crossover: lambda p, i, o:
    _crossover(p.Genes, i, o, get_fitness, crossover, fnMutate, fnGenerateParent)
 }
 ...
 for timeOut, improvement in _get_improvement(fnNewChild, fnGenerateParent, maxAge, poolSize, maxSeconds):
  if timeOut:
   return improvement
  display(improvement)
